...
<div class="container">
    <div class="card">
        ...
        <p>Kami sedang melakukan pemeliharaan rutin untuk memberikan layanan Koperasi yang lebih baik dan lebih aman bagi Anda.</p>
        ...
        <div class="footer">
            &copy; {{ date('Y') }} ARTEK By:Eko_teknik • Tim IT. EL.
        </div>
    </div>
</div>
