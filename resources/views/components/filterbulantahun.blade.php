    ...
    <div class="flex flex-col lg:flex-row lg:items-end gap-4 lg:gap-6">
        ...
        <div class="w-full sm:w-auto">
            <button
                ...
                <svg wire:loading.remove wire:target="exportPDF" class="w-5 h-5 opacity-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <svg wire:loading wire:target="exportPDF" class="animate-spin w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
