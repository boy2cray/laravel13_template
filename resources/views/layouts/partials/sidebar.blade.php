...
>
    ...
    <div class="px-3 py-2" x-show="isSidebarPinned || isSidebarHovered" x-cloak>
        <input
            ...
            type="text"
            placeholder="Cari ..."
            id="search_unq_<?= time(); ?>" {{-- Menggunakan ID dinamis agar browser tidak mengingatnya --}}
            name="field_pencarian"
            autocomplete="off" {{-- Memberitahu browser untuk tidak mengisi otomatis --}}
            readonly 
            onfocus="this.removeAttribute('readonly');" {{-- Mencegah autofill saat page load --}}
